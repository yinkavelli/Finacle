      ...
      <div className="w-full md:w-1/2 p-8 md:p-12 flex items-center justify-center relative">
        <div className="w-full max-w-md glass-panel p-8">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <button className="w-full flex items-center justify-center gap-2 bg-[var(--color-background)] border border-[var(--color-card-border)] hover:bg-[var(--color-foreground)]/5 py-2.5 rounded-lg font-medium transition-colors text-sm">
